# LP10 M02: Send and receive messages from Azure Queue storage
...
Locate the // ADD CODE TO DELETE MESSAGES AND THE QUEUE comment and add the following code directly after the comment. Be sure to review the code and comments.
